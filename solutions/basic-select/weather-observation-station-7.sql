/* ================================================================
   ...
   Problem #11 - Weather Observation Station 7      Difficulty: Easy
   ...
   ----------------------------------------------------------------
   Note: DISTINCT is required (STATION repeats city names). MS SQL
   Server LIKE is case-insensitive, so '%a' also matches 'Atlanta'.
   Both solutions below return the same result.
   ================================================================ */
